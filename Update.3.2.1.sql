...
SELECT 'Royal Mail defined European EU Countries', 'MODULE_SHIPPING_RMAMPARCELSF_ZONES_COUNTRIES_4', 'AL, AD, AM, AT', 'two character ISO country codes for Europe.', '6', '1', 'zen_cfg_textarea(', now() FROM configuration WHERE configuration_key  = 'MODULE_SHIPPING_RMAMPARCELS_ZONES_COUNTRIES_1';
...
SELECT 'Insurance rates ', 'MODULE_SHIPPING_RMAMPARCELSF_ZONES_COST0_4', '500:0,1000:1,2500:3', 'example: 200:1.2 means values less than or equal to £200 would cost &pound;1.20. to insure. 100+:4.5 means that each additional &pound;100 costs &pound;4.50 to insure.', '6', '0', 'zen_cfg_textarea(', now() FROM configuration WHERE configuration_key  = 'MODULE_SHIPPING_RMAMPARCELS_ZONES_COUNTRIES_1';
