...
SELECT @Pov2po_id := ifnull(products_options_values_to_products_options_id, @Pov2po_id) FROM products_options_values_to_products_options WHERE products_options_id= @options_id AND products_options_values_id = @LargeLetter_id;
...
SELECT @Pov2po_id := ifnull(products_options_values_to_products_options_id, @Pov2po_id) FROM products_options_values_to_products_options WHERE products_options_id= @options_id AND products_options_values_id = @SmallParcel_id;
...
SELECT @Pov2po_id := ifnull(products_options_values_to_products_options_id, @Pov2po_id) FROM products_options_values_to_products_options WHERE products_options_id= @options_id AND products_options_values_id = @MediumParcel_id;
...
SELECT @Pov2po_id := ifnull(products_options_values_to_products_options_id, @Pov2po_id) FROM products_options_values_to_products_options WHERE products_options_id= @options_id AND products_options_values_id = @ParcelForce_id;
