...
$define = [
    ...
    'MODULE_SHIPPING_RM2NDLETTER_TEXT_DESCRIPTION' => 'Royal Mail 2<sup>nd</sup> Class <span style="font-weight: normal; font-style: italic">&quot;Letter&quot;</span> Rates.  Weights in ' . TEXT_PRODUCT_WEIGHT_UNIT . '. <span style="font-style: italic">Rates valid until %s</span>',
