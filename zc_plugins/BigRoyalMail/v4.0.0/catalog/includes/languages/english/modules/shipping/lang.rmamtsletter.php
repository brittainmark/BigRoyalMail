...
$define = [
    ...
    'MODULE_SHIPPING_RMAMTSLETTER_TEXT_DESCRIPTION' => 'Royal Mail International Tracked &amp; Signed <span style="font-weight: normal; font-style: italic">&quot;Letter&quot;</span> Rates.  Weights in '.constant('TEXT_PRODUCT_WEIGHT_UNIT').'. <span style="font-style: italic">Rates valid until %s</span>',
