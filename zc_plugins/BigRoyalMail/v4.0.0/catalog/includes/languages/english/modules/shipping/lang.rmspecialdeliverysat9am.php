...
$define = [
    ...
    'MODULE_SHIPPING_RMSPECIALDELIVERYSAT9AM_TEXT_DESCRIPTION' => 'Royal Mail UK Guaranteed special delivery by <strong>9am</strong>&reg with <strong>Saturday Guatantee Rates.  Weights in ' . TEXT_PRODUCT_WEIGHT_UNIT . '. <span style="font-style: italic">Rates valid until %s</span>',
