...
$define = [
    ...
    'MODULE_SHIPPING_RMAMLETTERSF_TEXT_DESCRIPTION' => 'RM International Signed &quot;Letter&quot; Rates.  Weights in ' . TEXT_PRODUCT_WEIGHT_UNIT . '. <span style="font-style: italic">Rates valid until %s</span>',
