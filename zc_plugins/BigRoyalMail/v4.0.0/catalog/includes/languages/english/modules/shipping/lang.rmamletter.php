...
$define = [
    ...
    'MODULE_SHIPPING_RMAMLETTER_TEXT_DESCRIPTION' => 'Royal Mail International Standard <span style="font-weight: normal; font-style: italic">&quot;Letter&quot;</span> Rates.  Weights in ' . TEXT_PRODUCT_WEIGHT_UNIT . '. <span style="font-style: italic">Rates valid until %s</span>',
