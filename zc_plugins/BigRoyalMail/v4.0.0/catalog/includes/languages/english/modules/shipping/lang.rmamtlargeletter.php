...
$define = [
    'MODULE_SHIPPING_RMAMTLARGELETTER_TEXT_TITLE' => 'Royal Mail <strong>International Tracked</strong> <span style="font-weight: normal; font-style: italic">&quot;Large Letter&quot;</span>',
    'MODULE_SHIPPING_RMAMTLARGELETTER_TEXT_WAY' => '<strong>International Tracked</strong> delivery to %1$s : %2$s.<br />3+ days to Western Europe,<br />7+ days to rest of world.<br />Tracking can be provided.',
    'MODULE_SHIPPING_RMAMTLARGELETTER_INVALID_ZONE' => 'Not available for this destination.',
