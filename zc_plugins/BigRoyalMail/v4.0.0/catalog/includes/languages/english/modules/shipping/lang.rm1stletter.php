...
$define = [
    ...
    'MODULE_SHIPPING_RM1STLETTER_TEXT_DESCRIPTION' => 'Royal Mail First Class &quot;Letter&quot; Rates.  Weights in ' . TEXT_PRODUCT_WEIGHT_UNIT . '. <span style="font-style: italic">Rates valid until %s</span>',
