...
$define = [
    'MODULE_SHIPPING_RMPFGVALUE_TEXT_TITLE' => 'Royal Mail <strong style ="color:#025299">Parcel Force</strong> <span style="font-weight: normal; font-style: italic">&quot;Global Value&quot;</span>',
    'MODULE_SHIPPING_RMPFGVALUE_TEXT_WAY' => '<strong>Parcel Force Global Value</strong> delivery to %1$s : %2$s.<br />Delivery from 4 working days worldwide.<br />Tracking can be provided.',
    'MODULE_SHIPPING_RMPFGVALUE_INVALID_ZONE' => 'Not available for this destination.',
    'MODULE_SHIPPING_RMPFGVALUE_UNDEFINED_RATE' => 'The shipping rate cannot be determined at this time',
