...
$define = [
    ...
    'MODULE_SHIPPING_RMSMPARCEL_TEXT_DESCRIPTION' => 'Royal Mail International Economy <span style="font-weight: normal; font-style: italic">&quot;Small Parcel&quot;</span> Rates.  Weights in ' . TEXT_PRODUCT_WEIGHT_UNIT . '. <span style="font-style: italic">Rates valid until %s</span>',
