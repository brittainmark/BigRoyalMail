...
class rmt24medparcel extends ZenShipping
{
    /**
    ...
    public function install(): void
    {
        ...
        $db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'MODULE_SHIPPING_" . $module . "_SORT_ORDER', '214', 'Sort order of display.', '6', '0', now())");
