...
define('MODULE_SHIPPING_RMAMPARCELSF_TEXT_WAY', 'Royal Mail International Signed to %1$s : %2$s.<br />4+ days to Western Europe,<br />8+ days to rest of world.<br />Parcel requires a signature.');
