...
define('MODULE_SHIPPING_RMPFEXPRESS48_TEXT_TITLE', 'Royal Mail <b style ="color:#025299">Parcel Force</b> <span style="font-weight: normal; font-style: italic">&quot;express 48&quot;</span>');
...
define('MODULE_SHIPPING_RMPFEXPRESS48_TEXT_DESCRIPTION', 'Royal Mail Parcel Force <span style="font-weight: normal; font-style: italic">&quot;express 48&quot;</span> Rates. Weights in ' . TEXT_PRODUCT_WEIGHT_UNIT . '. <span style="font-style: italic">Rates valid until ' . MODULE_SHIPPING_RM_EXPIRES .'</span>');
