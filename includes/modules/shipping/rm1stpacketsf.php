...
class rm1stpacketsf {
	...
	// class constructor
	function rm1stpacketsf() {

		global $order, $total_weight;

		$this->version = '3.0.0';
		$this->code = 'rm1stpacketsf';
	...
	function install() {
		...
		if(!defined('MODULE_SHIPPING_' . $module . '_ZONES_COST0_1')){
			$db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Shipping rates to GB &amp; Northern Ireland', 'MODULE_SHIPPING_" . $module . "_ZONES_COST0_1', '0.75:3.65, 1:5.25, 1.25:6.55, 1.5:7.45, 1.75:8.35, 2:9.25, 4:11.25, 6:14.75, 8:18.25, 10:21.75, 12:25.25, 14:28.75, 16:32.25, 18:35.75, 20:39.25', 'Example: 0.1:1.14 means weights less than or equal to 0.1 Kg would cost &pound;1.14.', '6', '0', 'zen_cfg_textarea(', now())");
		}
		/*
