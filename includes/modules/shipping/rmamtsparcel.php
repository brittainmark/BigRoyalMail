...
class rmamtsparcel {
	...
	function install() {
		...
		if(!defined('MODULE_SHIPPING_' . $module . '_ZONES_COUNTRIES_1')){
			...
			$db->Execute('INSERT INTO ' . TABLE_CONFIGURATION . ' (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES (\'&quot;Rest of World&quot; Zone 2 rates from GB &amp; Northern Ireland\', \'MODULE_SHIPPING_' . $module . '_ZONES_COST0_3\', \'0.1:13.05, 0.25:14.4, 0.5:18.8, 0.75:21.6, 1:24.75, 1.25:27.15, 1.5:29.65, 2:30.7\', \'Example: 0.1:1.58 means weights less than or equal to 0.1 Kg would cost &pound;1.58.\', \'6\', \'0\', \'zen_cfg_textarea(\', now())');
		}
		if(!defined('MODULE_SHIPPING_' . $module . '_ZONES_COUNTRIES_4')){
		    ...
		    $db->Execute('INSERT INTO ' . TABLE_CONFIGURATION . ' (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES (\'&quot;Rest of World&quot; Zone 3 rates from GB &amp; Northern Ireland\', \'MODULE_SHIPPING_' . $module . '_ZONES_COST0_4\', \'0.1:13.85, 0.25:15.45, 0.5:20.85, 0.75:22.85, 1:26.5, 1.25:29.95, 1.5:32.7, 2:33.2\', \'Example: 0.1:1.58 means weights less than or equal to 0.1 Kg would cost &pound;1.58.\', \'6\', \'0\', \'zen_cfg_textarea(\', now())');
