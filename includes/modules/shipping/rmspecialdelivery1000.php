...
class rmspecialdelivery1000 {
	var $code, $title, $description, $enabled, $num_zones ;


	// class constructor
	function rmspecialdelivery1000() {

		global $order, $total_weight;

		$this->version = '3.1.0';
		$this->code = 'rmspecialdelivery1000';
	...
	function install() {
		...
		if(!defined('MODULE_SHIPPING_' . $module . '_ZONES_COST0_1')){
			$db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Shipping rates to GB &amp; Northern Ireland', 'MODULE_SHIPPING_" . $module . "_ZONES_COST0_1', '0.1:7.22, 0.5:7.95, 1:9.25, 2:12, 10:26.8, 20:41', 'Example: 0.1:1.14 means weights less than or equal to 0.1 Kg would cost &pound;1.14.', '6', '0', 'zen_cfg_textarea(', now())");
		}
		/*
