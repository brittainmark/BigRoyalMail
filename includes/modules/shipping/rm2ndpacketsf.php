...
class rm2ndpacketsf {
	...
	// class constructor
	function rm2ndpacketsf() {

		global $order, $total_weight;

		$this->version = '3.0.0';
		$this->code = 'rm2ndpacketsf';
