...
class rm2ndpacket {
	...
	// class constructor
	function rm2ndpacket() {

		global $order, $total_weight;

		$this->version = '3.0.0';
		$this->code = 'rm2ndpacket';
