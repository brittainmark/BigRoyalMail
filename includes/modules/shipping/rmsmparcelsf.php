...
class rmsmparcelsf {
	...
	// class constructor
	function rmsmparcelsf() {

		global $order, $total_weight;
		$this->version = '3.2.0';
		$this->code = 'rmsmparcelsf';
