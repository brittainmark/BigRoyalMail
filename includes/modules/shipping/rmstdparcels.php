...
class rmstdparcels {
	...
	// class constructor
	function rmstdparcels() {

		global $order, $total_weight;

		$this->version = '3.0.0';
		$this->code = 'rmstdparcels';
	...
	function install() {
		...
		if(!defined('MODULE_SHIPPING_' . $module . '_ZONES_COST0_1')){
			$db->Execute("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Shipping rates to GB &amp; Northern Ireland', 'MODULE_SHIPPING_" . $module . "_ZONES_COST0_1', '2:5.3, 4:8.8, 6:12.3, 8:15.8, 10:18.8, 20:21.9', 'example: 0.1:1.14 means weights less than or equal to 0.1 kg would cost &pound;1.14.', '6', '0', 'zen_cfg_textarea(', now())");
		}
		/*
